...
import FrmInwardTransfer from "./Pages/Inward/FrmInwardTransfer.jsx";
            ...
            element={
              <ProtectedRoute>
                <Routes>
                  ...
                  <Route path="/Inward/FrmInwardTransfer" element={<FrmInwardTransfer />} />
                  ...
                  <Route 
                    path="/Reports/FrmTransferDtlsRpt"
                    element={<FrmTransferDtlsRpt />}
                  />
